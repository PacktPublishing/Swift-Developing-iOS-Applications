...
arrayThree.insert(10, atIndex: 3) //arrayThree now contains 1, 2, 3, 10, 4 and 5
...
arrayFive.removeAtIndex(2)  //arrayFive now contains 1, 2 and 4
...
var reverse = arrayEight.reverse() //reverse contains 3,2 and 1
